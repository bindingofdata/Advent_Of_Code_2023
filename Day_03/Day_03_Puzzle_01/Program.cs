...
namespace Day_03_Puzzle_01
{
    internal static class Program
    {
        ...
        private static int ProcessEngineSchematicRow(string[] calibrationData, int rowNumber)
        {
            ...
            for (int currentRowIndex = 0; currentRowIndex < currentRow.Length; currentRowIndex++)
            {
                ...
                if (!Equals(currentRow[currentRowIndex], '.') &&
                    !char.IsNumber(currentRow[currentRowIndex]))
                {
                    subtotal += AddAdjacentNumbers(calibrationData, rowNumber, currentRowIndex);
                }
            }
        ...
        private static int AddAdjacentNumbers(string[] calibrationData, int rowNumber, int currentRowIndex)
        {
            int subtotal = 0;
            ...
            for (int indexOffset = -1; indexOffset < 2; indexOffset++)
            {
                ...
                subtotal += GetRowValues(ref previousRow, rootIndex, out rightDigitCount);
            ...
            {
                rootIndex = currentRowIndex + indexOffset;
                subtotal += GetRowValues(ref nextRow, rootIndex, out rightDigitCount);
            ...
            subtotal += GetRowValues(ref currentRow, rootIndex, out _);
        ...
        private static int GetRowValues(ref ReadOnlySpan<char> testRow, int rootIndex, out int rightDigitCount)
        {
            char currentChar;
            ...
            {
                subtotal += int.Parse(testRow.Slice(rootIndex - (leftDigitCount - 1), totalDigitCount));
            }
